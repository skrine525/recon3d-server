...
from .views import CalculateInitialMaskView, CalculateHoughView, SaveReconstructionView, ReconstructionListCreateView, ReconstructionRetrieveView
...
urlpatterns = [
    ...
    path('reconstructions/<int:id>', ReconstructionRetrieveView.as_view(), name='reconstruction-detail'),
] 